...
export default function Pagina() {
    ...
    return (
        <div className="w-full h-screen flex flex-col bg-gray-200 text-white gap-3">
            ...
            <main className="flex-1 flex flex-col justify-center items-center px-6 text-center gap-6 mt-20">
                <div className="space-y-2 flex flex-col gap-3">
                    ...
                    <p className="text-gray-800 max-w-lg mx-auto text-lg">
                ...
                <div className="flex flex-wrap gap-4 justify-center mt-4">
                    ...
                    <Link 
                        href="/register" 
                        className="bg-gray-700 hover:bg-gray backdrop-blur-md border border-white/10 text-white font-bold px-8 py-3 rounded-lg transition-all"
                    >
                        Crear Cuenta
                    </Link>
                </div>
            ...
            <section className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 p-12 mb-20">
                <div className="bg-gray-700 p-6 rounded-2xl border border-white/5 hover:border-blue-500/50 transition-colors">
